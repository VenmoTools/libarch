...
use crate::arch::intel::chips::flags::LocalAPICFlags;
use crate::arch::intel::interrupt::ApicInfo;
use crate::arch::intel::interrupt::x2apic::consts::*;
/// this code base on https://github.com/kwzhao/x2apic-rs

use crate::arch::intel::interrupt::x2apic::register::{IpiAllShorthand, IpiDeliveryMode, IpiDestMode, LocalApicRegisters, TimerDivide, TimerMode};
