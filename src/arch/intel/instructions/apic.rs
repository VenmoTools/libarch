use super::super::instructions::register::wrmsr2;
...
unsafe fn mask_all_lvt() {
    use super::super::chips::consts::{
        IA32_X2APIC_IRR0, IA32_X2APIC_LVT_TIMER,
        IA32_X2APIC_LVT_THERMAL, IA32_X2APIC_LVT_PMI,
        IA32_X2APIC_LVT_LINT0, IA32_X2APIC_LVT_LINT1,
