...
use crate::arch::intel::chips::msr_set::Efer;
...
pub unsafe fn enable_4_level_paging(args: PagingArgs) {
    ...
    use crate::arch::intel::chips::flags::{CR4Flags, EferFlags, CR0Flags};
    use crate::arch::intel::chips::control::{CR4, CR0};
    use crate::arch::intel::x64::address::PhysAddr;
    ...
    let mut msr_flag = Efer::new();
    let mut flags = msr_flag.read();
    flags |= EferFlags::NO_EXECUTE_ENABLE | EferFlags::LONG_MODE_ENABLE;
    msr_flag.write(flags);
