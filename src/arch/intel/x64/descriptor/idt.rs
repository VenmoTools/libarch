...
use crate::arch::intel::instructions::segmention::cs;
use crate::arch::intel::instructions::tables::lidt;
use crate::arch::intel::PrivilegedLevel;
use crate::arch::intel::x64::{DescriptorTablePointer, SegmentSelector};
use crate::arch::intel::x64::address::VirtAddr;
use crate::arch::intel::x64::descriptor::flags::IdtFlags;
...
impl<F> Entry<F> {
    ...
    fn set_handler_addr(&mut self, addr: u64) -> &mut EntryOptions {
        ...
        self.gdt_selector = cs::<SegmentSelector>().0;
